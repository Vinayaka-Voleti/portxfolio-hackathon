...
const socialLinks = [
    {
      href: 'https://github.com/Vinayaka-Voleti',
    ...
    {
      href: 'https://www.linkedin.com/in/vinayaka-voleti-489061201/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form action="" method='POST' className="xl:pl-10 2xl:pl-20 ">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name='name' id='name' autoComplete='name' required placeholder='Vinayaka Voleti' className="text-field" />
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name='email' id='email' autoComplete='email' required placeholder='Vamsi@example.com' className="text-field" />
                    ...
                    <div className="mb-4">
                        ...
                        <textarea name="message" id='message' placeholder='Hi' required className="text-field resize-y min-h-32 max-h-80" />
